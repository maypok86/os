...
do
	...
	script_info=$(cat current_top | grep "mem.bash" | awk '$8 == "R" { print $0 }')
	...
	then
		...
		#script info
		echo "Information about mem.bash:" >> "$report_log"
		echo "$script_info" | awk '{ print $10 }' >> "$mem_log"
		...
		dmesg | grep "mem.bash" | tail -n 2 >> "$report_log"
		exit
	fi
